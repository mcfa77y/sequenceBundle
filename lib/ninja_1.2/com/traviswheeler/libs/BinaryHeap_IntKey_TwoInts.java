 ...
 */
public class BinaryHeap_IntKey_TwoInts extends BinaryHeap_IntKey {
     ...
     */
    public BinaryHeap_IntKey_TwoInts( ) {
    	super();
    }
    
    public BinaryHeap_IntKey_TwoInts(int maxCapacity ) {
    	super(maxCapacity);
    }
     ...
     */
    public BinaryHeap_IntKey_TwoInts( int[] val1s, int[] val2s, int[] keys ) {    	
    	buildAgain(val1s,val2s,keys);        
    }
    
    public BinaryHeap_IntKey_TwoInts( int[] val1s, int[] val2s, int[] keys, int maxCapacity ) {
    	this.maxCapacity = maxCapacity; 
    	buildAgain (val1s, val2s, keys);
    }

    
    public void buildAgain ( int[] val1s, int[] val2s, int[] keys ) {
    ...
    public void chopBottomK (int[] val1s, int[] val2s, int[] keys ) {
    	int k = keys.length;
