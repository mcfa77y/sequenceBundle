 ...
 */
public class BinaryHeap_IntKey  {
     ...
     */
    public BinaryHeap_IntKey( ) {
    	init (0,DEFAULT_CAPACITY);
    }

    public BinaryHeap_IntKey(int maxCapacity ) {
     ...
     */
    public BinaryHeap_IntKey( int[] val1s, int[] keys ) {
    	buildAgain (val1s, keys);
    }

    public BinaryHeap_IntKey( int[] val1s, int[] keys, int maxCapacity ) {
    	this.maxCapacity = maxCapacity; 
    	buildAgain (val1s, keys);
    }
    
    public void buildAgain ( int[] val1s, int[] keys ) {
