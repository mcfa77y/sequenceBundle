<%--
    Document   : form
    Created on : Jan 2, 2015, 1:18:34 PM
    Author     : joelau
--%>
...
<html>
    <head>
        ...
        <script type='text/javascript' src='<c:url value="/resources/javascripts/util.js"/>'></script>
        <script type='text/javascript' src='<c:url value="/resources/javascripts/jqueryFileUpload/vendor/jquery.ui.widget.js"/>'></script>
        <script type='text/javascript' src='<c:url value="/resources/javascripts/jqueryFileUpload/jquery.iframe-transport.js"/>'></script>
        <script type='text/javascript' src='<c:url value="/resources/javascripts/jqueryFileUpload/jquery.fileupload.js"/>'></script>
        <title>Upload</title>
