...
public class AlvisController implements ServletContextAware {
    ...
    public void setServletContext(ServletContext servletContext) {
        ...
        System.out.println("AlvisController.java - ServletContext: images - " + this.servletContext.getRealPath("/images"));
        System.out.println("AlvisController.java - ServletContext: root - " + this.servletContext.getRealPath("/"));
