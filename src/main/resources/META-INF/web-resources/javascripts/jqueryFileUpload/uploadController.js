...
$(function () {
    ...
    $("#useExampleForm").submit(function (event) {
        ...
        var $form = $(this),
                url = $form.attr("action");
        var data = Utils.createData(
                {alignmentType: 'AMINOACIDS', filename: filename});
        renderImage(url, data);
    });

    var descriptionMap = {'ABC_tran-(PF00005)_ATP-binding-domain-of-ABC-transporters.txt': 'In living organisms, ABC transporters are responsible for moving molecules across cellular membranes. To do this job, they require energy generated by their ATP-domains.\
Source: Pfam (PF00005)',
