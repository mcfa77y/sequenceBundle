$(function() {
	...
	$.post("upload/seq/status", {
		...
		var link = $('<a/>').attr('href', imagePath).attr('download', filename);
		renderHiResInfo('upload-status-success', 'Rendering Complete', true);
	...
	posting.done(function(data) {
		...
		renderHiResInfo('upload-status-error', errorMessage, false);
		return;
	    }
	    var d = new Date();
